...
#ifndef QML6_ROS2_PLUGIN_INTERNAL_RING_BUFFER_HPP
#define QML6_ROS2_PLUGIN_INTERNAL_RING_BUFFER_HPP
 ...
 * WARNING: This is an internal utility class and the API may be changed at any time.
...
public:
  ...
  {
    return const_iterator( const_cast<RingBuffer *>( this ), get_head_index() );
  }

  //! @returns a const iterator pointing to the position after the newest element in the ringbuffer.
  const_iterator cend() const noexcept
  {
    return const_iterator( const_cast<RingBuffer *>( this ), get_head_index(), size_ );
  }
...
#endif // QML6_ROS2_PLUGIN_INTERNAL_RING_BUFFER_HPP
